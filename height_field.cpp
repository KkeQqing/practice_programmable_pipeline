...
//const float GRID_SIZE = 1.0f; // 每个格子的物理尺寸（米）
//const float DAMPING = 0.995f;
//const float WAVE_SPEED = 2.0f;
//const float TIME_STEP = 1.0f / 60.0f;
//
//// 水面高度场
//float height[GRID_HEIGHT][GRID_WIDTH] = { 0 };
//float prev_height[GRID_HEIGHT][GRID_WIDTH] = { 0 };
//
//// 渲染数据
//GLuint VAO, VBO, EBO;
...
//uniform sampler2D heightMap; // 可选：这里我们直接用顶点Y，但保留扩展性
//out vec3 Normal;
//out vec3 FragPos;
//
//void main() {
